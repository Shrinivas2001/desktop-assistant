...
def wishMe():
    ...
    speak("I am your  Virtual  Assistant Suzi. Please tell me how may I help you")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('shrinivas9620328708@gmail.com', 'jjhighneknixgyyy')
    server.sendmail('shrinivas9620328708@gmail.com', to, content)
    server.close()
...
if __name__ == "__main__":
    ...
    # if 1:
        ...
        if 'wikipedia' in query:
            ...
            speak(" For your information Shrinivas Kulkarni Created me !    I can show you his Linked In profile if you want to see.    Yes or no .....")
